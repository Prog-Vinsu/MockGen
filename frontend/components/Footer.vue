    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="space-y-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xl font-bold"
              >Mock<span class="text-blue-400">Gen</span></span
            >
          </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400 text-sm">
            <li class="flex items-start">
              ...
              <span>tognerepoloniniv@gmail.com</span>
            </li>
            <li class="flex items-start">
              <svg
                  class="w-4 h-4 mt-0.5 mr-2 flex-shrink-0"
        ...
        <div>
          ...
          <form class="space-y-3">
            <input
              ...
              class="w-full px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 text-white text-sm"
            />
            <button
              type="submit"
      ...
      >
        <p class="text-gray-400 text-sm text-center md:text-left mb-4 md:mb-0">
          &copy; {{ new Date().getFullYear() }} MockGen. Todos os direitos
          reservados.
        </p>
